...
public class FontPickerPrefDialog extends DialogPreference implements DialogInterface.OnClickListener
{
	...
	public FontPickerPrefDialog( Context context, AttributeSet attrs )
	{
		super(context, attrs);
	}
